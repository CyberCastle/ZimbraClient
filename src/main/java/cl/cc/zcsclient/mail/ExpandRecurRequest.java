...
/**
 * <p>
 * Java class for expandRecurRequest complex type.
 *
 * <p>
...
public class ExpandRecurRequest {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the compOrExceptOrCancel property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list null     {@link ExpandedRecurrenceInvite }
